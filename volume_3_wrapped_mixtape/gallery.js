  ...
  for (const art of arts) {
    ...
    newDiv.innerHTML = `
      <div class="card">
          ...
          <div class="art-title"><p>${art.title}</p></div>
          <div class="art-media-type"><p>${art.type}</p></div>
          <div class="art-media-contributers">${art.Collaborators}</div>
          <div class="art-media-description"><p>${art.topicsummary}</p></div>
          <button class="less-pretentious">click to see less pretentious description</button>
          <button class="hidden more-pretentious">click to see more pretentious description</button>
